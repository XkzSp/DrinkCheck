        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-2xl">DrinkCheck</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              La solución más avanzada en seguridad para bebidas. Protegemos lo que importa 
              con tecnología de detección instantánea y alertas inteligentes.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">info@drinkcheck.com</span>
              </li>
              <li className="flex items-center space-x-2">
              ...
              <li className="flex items-start space-x-2">
                ...
                <span className="text-gray-400">123 Innovation Ave<br />Tech City, TC 12345</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-4 md:mb-0">
              © 2025 DrinkCheck. Todos los derechos reservados.
            </p>
